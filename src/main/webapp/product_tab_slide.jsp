                ...
                <div class="col-md-12">
                    <c:forEach items="${e.parameterList}" var="product">
                        <div class="col-md-4" style="margin-bottom: 5px;padding-right: 2px;">
                            <b><c:out escapeXml="false" value="${product.name}"/> : </b><c:out escapeXml="false"
                                                                                               value="${product.value}"/><br>
                        </div>
                    </c:forEach>
                </div>
            </div>
                                ...
                                <ul class="media-list">
                                    <li class="media">
									    <span class="pull-left" href="#">
									      <img class="media-object err-product"
                                               style="width: 50px;height: 50px;border: 0px;" alt=""
                                               src="http://myshopxx.oss.aliyuncs.com//20140304/1393900153455_3.jpg">
									      (金牌会员)
									    </span>

                                        <div class="media-body">
                                            <h4 class="media-heading"><c:out escapeXml="false"
                                                                             value="${comment.nickname}"/></h4>
